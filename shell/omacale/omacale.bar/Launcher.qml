...
// Typing ">" lists Omarchy actions instead of apps.
Item {
  id: root
  ...
  implicitWidth: Tk.sizes.launcherItemWidth + padding * 2
  implicitHeight: listH + padding + padding + searchBox.height + Math.max(0, padding - Tk.border)
  ...
  Row {
    ...
    scale: root.results.length === 0 ? 1 : 0.5
    padding: Tk.padding.large
    spacing: Tk.spacing.medium
    Behavior on opacity { Anim { type: "effects" } }
    Behavior on scale { Anim {} }
    MIcon { anchors.verticalCenter: parent.verticalCenter; text: "manage_search"; size: Tk.iconSize.extraLarge; color: Colours.m3onSurfaceVariant }
    Column {
      anchors.verticalCenter: parent.verticalCenter
      MText { text: "No results"; color: Colours.m3onSurfaceVariant; font.pointSize: Tk.body.large; weight: Font.Medium }
      MText { text: "Try searching for something else"; color: Colours.m3onSurfaceVariant; font.pointSize: Tk.body.medium }
    }
  }
