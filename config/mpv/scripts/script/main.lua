...
local animation = require "script.core.animation"
local animation_coordinator_module = require "script.core.animation_coordinator"
local application_state = require "script.core.application_state"
local frame_runtime = require "script.core.frame_runtime"
local controller_module = require "script.core.controller"
local navigation_module = require "script.core.navigation"
local mpv_runtime_module = require "script.core.mpv_runtime"

local compose_module = require "script.ui.compose"
local playback_indicator_module = require "script.ui.components.playback_indicator"
local seekbar_renderer_module = require "script.ui.components.seekbar_renderer"
local loading_indicator = require "script.ui.loading_indicator"
local ui_renderer_module = require "script.ui.renderer"
local text_metrics_module = require "script.ui.text_metrics"
local tooltip_service_module = require "script.ui.tooltip_service"

local snapshot_module = require "script.services.snapshot"
local assets = require "script.services.assets"
local player_module = require "script.services.player"
local directory_playlist_module = require "script.services.directory_playlist"
local stream_quality_module = require "script.services.stream_quality"
local subtitle_loader_module = require "script.services.subtitle_loader"
local thumbnail_module = require "script.services.thumbnail_service"

mp.set_property("osc", "no")
mp.set_property_bool("auto-window-resize", false)

local controls_module = require "script.ui.components.controls"
local popups_module = require "script.ui.components.popups"
local playlist_module = require "script.ui.components.playlist"
