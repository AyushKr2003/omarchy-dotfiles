...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="header">
                <div>
                    <div class="prompt">shadow@omarchy:~$ <span>open</span></div>
            ...
            <div class="grid">
                ...
                <a href="https://ayushkr2003.github.io/AyushKr2003/" class="card">
                    <span class="card-icon">󰸌</span>
                    <div class="card-info">
                        <span class="card-title">Portfolio</span>
                        <span class="card-key">ayushkr2003.github.io</span>
                    </div>
                </a>
